function [idx_clu,clu_num] = cluster_snr(snr_mat,clu_num,idx_clu,constants)
...
% get the thresholds
perc_threshold = constants.perc;
stim_thres = constants.stimuli;
num_thres = constants.num_thres;
...
snr_thres = prctile(clu_snr,perc_threshold,2);
